...
public class QiNiuUtil {
    private static final String ACCESSKEY = "BqFhE2-s9LW44A4F840TLZUwLXULa7dIli9V5dly";
    private static final String SECRETKEY = "olxcWGZqgpKBcADXVnEOpYfzVKZaXmWwn1LNnE9L";
    private static final String BUCKET = "health";
    public static final String DOMAIN = "http://pv1lzl6iy.bkt.clouddn.com";

    public static void main(String[] args) {
        uploadFile("C:\\Users\\Administrator\\Desktop\\霸气侧漏.jpg", "霸气.jpg");
